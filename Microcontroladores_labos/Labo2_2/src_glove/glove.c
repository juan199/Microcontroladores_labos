...
#include <libopencm3/stm32/f4/timer.h> //Desde example.c
#include <libopencm3/stm32/f4/nvic.h> //Desde example.c
...
#define CONVERSION_FACTOR_JOINT_0 1.0f// factores de conversión para el divisor de tensiones
#define CONVERSION_FACTOR_JOINT_1 1.0f
#define CONVERSION_FACTOR_JOINT_2 1.0f
#define CONVERSION_FACTOR_JOINT_3 10.0f
...
void DTC_SVM_tim_init(void) //Temporizador
{
	...
	timer_set_mode(TIM1, TIM_CR1_CKD_CK_INT, //For dead time and filter sampling, not important for now.
		      TIM_CR1_CMS_EDGE, //TIM_CR1_CMS_CENTER_3,
